...
export const crises: Crisis[] = [
    ...
    },
    {
      ...
      options: [
        { label: 'Solicitar un préstamo de emergencia', costText: 'Préstamo', cost: 0, effect: 'Suma 25.000 CC a tesorería pero genera deuda y una penalización de -20 PEB en Finanzas.' },
        ...
        { label: 'Utilizar reservas de tesorería', costText: '0 CC', cost: 0, effect: 'Se asume la pérdida de 25.000 CC directamente contra la tesorería actual. No genera penalizaciones directas.' },
        { label: 'Retrasar pagos a proveedores', costText: '0 CC', cost: 0, effect: 'Evita la pérdida de la subvención. Impacto: +8 XP Finanzas, −8 XP Reputación.' },
      ]
    },
    {
      id: 'C3',
      ...
      options: [
        ...
        { label: 'Subir temporalmente la matrícula a los alumnos solventes', costText: '0 CC', cost: 0, effect: 'Impacto: −5 XP Reputación, +5 XP Finanzas; se compensa el déficit pero se genera mala imagen.' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Lanzar una campaña positiva', costText: '-8.000 CC', cost: -8000, effect: 'Impacto: −8.000 CC, +3 XP Reputación, +10 IAM; neutraliza la crisis y puede atraer alumnos adicionales en el MAM' },
      ]
    },
    {
        id: 'C5',
        ...
        options: [
          ...
          { label: 'Contratar personal sanitario temporal', costText: '-5.000 CC', cost: -5000, effect: 'Impacto: −5.000 CC, +3 XP Personal, +5 Moral' },
