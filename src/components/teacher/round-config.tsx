      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Configuración de Rondas</CardTitle>
              <CardDescription>
                Define las inversiones y crisis para cada ronda de la partida.
              </CardDescription>
            </div>
        ...
        <CardContent>
          <Tabs defaultValue="investments">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="investments">Inversiones de la Ronda</TabsTrigger>
              <TabsTrigger value="crises">Crisis de la Ronda</TabsTrigger>
            </TabsList>
            <TabsContent value="investments" className="mt-4">
              <div className="rounded-lg border">
                <div className="p-4 flex justify-between items-center border-b">
                    <p className="text-sm text-muted-foreground">Define qué inversiones estarán disponibles para qué equipos en esta ronda.</p>
            ...
            <TabsContent value="crises" className="mt-4">
                 <div className="rounded-lg border">
                    <div className="p-4 flex justify-between items-center border-b">
                        <p className="text-sm text-muted-foreground">Define qué crisis se activará para todos los equipos en esta ronda.</p>
